    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="enrollment.php">Enrollment <span
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="enrollmentModalLabel">Enrollment</h5>
...
<script>
    $(document).ready(function () {
        ...
        $('#confirmDelete').click(function () {
            var enrollment_id = $(this).data('enrollment-id');
            window.location.href = '/finalexamination/setup.php?delete_enrollment=' + enrollment_id;
        });
